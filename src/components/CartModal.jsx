                                ...
                                <div className="mb-2">
                                    <div className="d-flex justify-content-between">
                                        <div className="d-flex justify-content-start">
                                            ...
                                            {
                                                product.quantity > 1 ? (
                                                    <p className='mt-3 fw-bold mx-5 delete-product' onClick={() => deleteProduct(product)}>-1</p>
                                                ):(
                                                    <p className='mt-3 fw-bold mx-5 delete-product' onClick={() => deleteProduct(product)}>X</p>
                    ...
                    <div className="d-flex justify-content-end">
                        
                        {
                            cartList.length > 0 && (
                                ...
                                <Link to={'/paypage'} className='btn btn-primary mx-3 mt-3'>Go to pay</Link>
                                </>
                            )
                        }
